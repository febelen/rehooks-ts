...
```jsx
import { useKeyPress } from "@febelen/rehooks-ts";
...
```ts
function useKeyPress(options: KeyPressOptions): boolean;
```
...
| ------------- | ----------------- | ------------------------------------------------ |
| options       | `KeyPressOptions` | The configuration for the key press detection.   |
...
| Name      | Type      | Description                                                                                                                                                 |
| --------- | --------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| isPressed | `boolean` | `true` if the specified key combination is currently pressed, `false` otherwise. This value is updated whenever the key combination is pressed or released. |
